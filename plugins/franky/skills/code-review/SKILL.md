---
name: code-review
description: "Use before merging any change, after finishing a feature or bug fix, or when reviewing code written by yourself, another agent, or a human. Conducts a multi-axis review across correctness, readability, architecture, security, and performance, and returns severity-labeled findings with a verdict."
---
...
| **Nit:** | Minor, optional | Author may ignore, formatting or style preferences |
